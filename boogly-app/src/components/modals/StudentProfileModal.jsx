...
export default function StudentProfileModal({
  ...
  const renderRow = (label, value) => (
    ...
    >
      <div
        style={{ minWidth: 110, color: theme.muted, ...theme.typography.small }}
      >
        {label}:
      </div>
      <div
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3 style={{ ...theme.typography.h3, color: theme.text }}>
            Perfil do Aluno
          </h3>
        ...
        <div style={{ minHeight: 80 }}>
          ...
          {error && (
            <div style={{ color: 'var(--danger, #dc2626)' }}>{error}</div>
          )}
          ...
          {!loading && !error && (
            <>
              ...
              {renderRow(
                ...
                formatBool(user?.onboardingDone)
              )}
