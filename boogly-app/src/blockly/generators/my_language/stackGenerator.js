...
/* ==========================================================
   CRIAR PILHA
   ========================================================== */
javascriptGenerator.forBlock['stack_container'] = function (block) {
...
/* ==========================================================
   CRIAR PILHA FIXA
   ========================================================== */
javascriptGenerator.forBlock['stack_fixed'] = function (block) {
  const name = block.getFieldValue('NAME');
  ...
  if (sizeBlock) {
    const generated = javascriptGenerator.blockToCode(sizeBlock);

    size = Array.isArray(generated) ? generated[0] : generated;
  }
...
javascriptGenerator.forBlock['push'] = function (block) {
  ...
  if (valueBlock) {
    const generated = javascriptGenerator.blockToCode(valueBlock);

    value = Array.isArray(generated) ? generated[0] : generated;
  }
...
/* ==========================================================
   DESEMPILHAR
   ========================================================== */
javascriptGenerator.forBlock['pop'] = function (block) {
  const stack = block.getFieldValue('STACK');
...
/* ==========================================================
   TOPO
   ========================================================== */
javascriptGenerator.forBlock['peek'] = function (block) {
  const stack = block.getFieldValue('STACK');

  return [`topo("${stack}")`, javascriptGenerator.ORDER_ATOMIC];
};

/* ==========================================================
   TAMANHO
   ========================================================== */
javascriptGenerator.forBlock['stack_size'] = function (block) {
  const stack = block.getFieldValue('STACK');

  return [`tamanho_pilha("${stack}")`, javascriptGenerator.ORDER_ATOMIC];
};
...
javascriptGenerator.forBlock['stack_empty'] = function (block) {
  ...
  return [`pilha_vazia("${stack}")`, javascriptGenerator.ORDER_ATOMIC];
};
